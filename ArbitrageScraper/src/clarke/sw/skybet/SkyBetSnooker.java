...
public class SkyBetSnooker extends MakeMatches implements RetrieveOdds, Callable<LinkedList<Matches>> {
	...
	private String page = "https://www.skybet.com/snooker/betType/match-result";
	...
	// SkyBetSnooker sb = new SkyBetSnooker();
	//
	// Document doc =
	// sb.getConnection("https://www.skybet.com/snooker/betType/match-result");
