...
public class PaddyPowerTennis extends MakeMatches implements RetrieveOdds, Callable<LinkedList<Matches>> {
	...
	private String page = "http://www.paddypower.com/bet/tennis/tennis-coupon";
	...
	public Document getConnection(String url) throws Exception {
		...
		return document;
		// } catch(Exception e){
		// System.out.println("Error in paddy power connection: " +
		// e.getMessage());
		// return null;
		// }
	}
...
//		PaddyPower pp = new PaddyPower();
//		
//		Document docpp = pp.getConnection("http://www.paddypower.com/bet/tennis/tennis-coupon");
//		LinkedList<Player> players = pp.getTennisOdds(docpp);
//		LinkedList<Matches> matches = pp.getMatches(players, Sports.TENNIS);
